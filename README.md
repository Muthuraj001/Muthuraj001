...
**Intern - Software Testing** | *Salesqueen Software Solution, Chennai*
*(Jan 2026 - Present)*
- Logged software issues, reported bugs to the development team, and shared detailed reports.
- Monitored tasks and deadlines to maintain workflow efficiency.

**Intern - Web Design** | *IPCS Global Tech, Tirunelveli*
*(Sept 2024)*
- Designed web pages with clean structures, simple menus, and beginner-level styling.
- Focused on arranging content logically to improve page flow and user experience.
- Explored responsive design steps to ensure pages render well on different screens.

**Intern - Web Development** | *Buleline Tech Solution, Kovilpatti*
*(May 2024 - Jun 2024)*
- Developed small web projects using clean and modern coding practices.
...
- **Higher Secondary Education** | Nadar Hr. Sec. School, Kovilpatti - Tuticorin *(Jun 2019 - May 2020)*

## 📫 Connect with me
- **Email:** muthuraj.p001@gmail.com
